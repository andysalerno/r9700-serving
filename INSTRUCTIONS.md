...
podman compose --env-file .env/env.rocm714 --env-file .env/env.vllm.nightly --profile vllm-rocm-wheel-gfx12x-patched up

Note, you must first build the profile it depends upon:

podman compose --env-file .env/env.rocm714 --env-file .env/env.vllm.nightly --profile vllm-rocm-wheel-nightly build
